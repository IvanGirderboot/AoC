...
func (gb *GameBoard) checkIfWinner() (isWinner bool, details string) {
	if gb.has_won {
		return false, "Game board has already won"
	}
	//check the rows
